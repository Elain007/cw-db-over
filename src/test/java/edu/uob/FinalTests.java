...
public class FinalTests {
    ...
    public void testDoc() {
        ...
        assertTrue(response.contains("1\tSimon\t65\t"));
    ...
    public void testDifficult2() {
        ...
        response = sendCommandToServer("drop table balabala;");
        assertFalse(response.contains("[OK]"), "A valid query was made, however an [OK] tag was not returned");
        assertTrue(response.contains("[ERROR]"), "A valid query was made, however an [ERROR] tag was returned");

        response = sendCommandToServer("drop database balabala;");
        assertFalse(response.contains("[OK]"), "A valid query was made, however an [OK] tag was not returned");
        assertTrue(response.contains("[ERROR]"), "A valid query was made, however an [ERROR] tag was returned");
    }
    ...
    public void testUpperCases() {
        String upperCaseName = generateRandomName().toUpperCase();
        String lowerCaseName = upperCaseName.toLowerCase();
        String otherCaseName = lowerCaseName.substring(0, 5) + upperCaseName.substring(5, upperCaseName.length());
        String response;
        sendCommandToServer("CREATE DATABASE " + upperCaseName + ";");
        response = sendCommandToServer("USE  " + upperCaseName + ";");
        assertTrue(response.contains("[OK]"), "A valid query was made, however an [OK] tag was not returned");
        assertFalse(response.contains("[ERROR]"), "A valid query was made, however an [ERROR] tag was returned");
        ...
        response = sendCommandToServer("CREATE TABLE test (name, naMe, Name);");
        assertFalse(response.contains("[OK]"), "A valid query was made, however an [OK] tag was not returned");
        assertTrue(response.contains("[ERROR]"), "A valid query was made, however an [ERROR] tag was returned");

        response = sendCommandToServer("INSERT INTO Marks VALUES('%.{$abc}abc', 65.1, TRUE);");
        assertTrue(response.contains("[OK]"), "A valid query was made, however an [OK] tag was not returned");
        assertFalse(response.contains("[ERROR]"), "A valid query was made, however an [ERROR] tag was returned");

        response = sendCommandToServer("USE " + otherCaseName + ";");
        assertTrue(response.contains("[OK]"), "A valid query was made, however an [OK] tag was not returned");
        assertFalse(response.contains("[ERROR]"), "A valid query was made, however an [ERROR] tag was returned");
        ...
        response = sendCommandToServer("SELECT * FROM marks WHERE () AND ();");
        assertFalse(response.contains("[OK]"), "A valid query was made, however an [OK] tag was not returned");
        assertTrue(response.contains("[ERROR]"), "A valid query was made, however an [ERROR] tag was returned");
